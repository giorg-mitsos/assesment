...
class Vacation
{
    ...
    public function create(int $user_id, string $start_date, string $end_date, string $reason, string $status = 'pending',): bool
    {
    ...
    public function find($vacation_id)
    {
    ...
    public function whereUserId(int $user_id): ?array
    {
    ...
    public function whereStatus(string $status = 'pending'): ?array
    {
    ...
    public function deleteUserVacationRequests(int $user_id): void
    {
